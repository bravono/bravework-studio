...
const portfolios: Portfolio[] = [
  ...
  },
  {
    ...
    title: "SaaS",
    category: "Web Development",
    image: "/services/research_lib.png",
  ...
  },
{
  ...
  title: "Website",
  category: "Web Development",
  image: "/services/passport_legend.png",
  description: "Website to help people gain citizenship and residency around the world",
  iFrame: `https://passportlegend.com`,
  otherSamples: [
    "https://passportlegend.com/services",
    "https://passportlegend.com/contact"
  ],
  details: {
    client: "Passport Legend",
    year: "2026",
    tools: ["React", "Next.js", "JavaScript", "TypeScript"],
    description: "A responsive, multilingual platform designed to guide users through the process of obtaining citizenship and residency in various countries. The site integrates dynamic content, secure form submissions, and interactive resources to simplify complex legal information.",
    challenges: [
      "Presenting complex immigration and residency information in a clear, user-friendly format",
      "Ensuring multilingual support for a global audience",
      "Maintaining strong security for sensitive user data",
      "Optimizing performance for users across different regions and devices"
    ],
    solutions: [
      "Implemented a modular Next.js architecture for scalability and SEO optimization",
      "Integrated internationalization (i18n) libraries to support multiple languages",
      "Applied secure authentication and encrypted form handling for user submissions",
      "Used server-side rendering and caching strategies to improve global performance"
    ],
  },
},
  {
    ...
    title: "Web App",
    category: "Web Development",
    image: "/services/smart_hill.png",
    description: "An app that automates the process of buying and selling of land and property",
    iFrame: ``,
    otherSamples: [],
    details: {
      client: "Smart Hill",
