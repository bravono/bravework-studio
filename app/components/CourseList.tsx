...
export default function coursesPage({ page }) {
  ...
  const coursesToDisplay = atHome ? courses.slice(0, 4) : courses;
    ...
    <>
      ...
      >
        <div className="text-center mb-12">
          <h1
            className={`${courseHeading} text-4xl md:text-5xl font-extrabold`}
          >
            Available Courses
          </h1>
          <p className={`${courseHeading} text-lg max-w-2xl mx-auto`}>
