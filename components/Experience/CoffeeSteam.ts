...
import vertexShader from './shaders/coffeeSteam/vertex'
import fragmentShader from './shaders/coffeeSteam/fragment'
...
export default class CoffeeSteam
{
    ...
    setModel()
    {
        ...
        // Mesh
        const originalMesh = this.resources.items.coffeeSteamModel.scene.children[0]
        this.model.mesh = originalMesh ? originalMesh.clone() : null

        if (!this.model.mesh)
        {
            console.error('coffeeSteamModel mesh not found')
            return
        }
