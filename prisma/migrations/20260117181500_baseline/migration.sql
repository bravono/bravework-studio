...
CREATE TABLE "budget_ranges" (
    ...
    CONSTRAINT "budget_ranges_pkey" PRIMARY KEY ("budget_range_id")
);
...
-- CreateTable
CREATE TABLE "custom_offer_statuses" (
...
-- CreateTable
CREATE TABLE "job_app_app_files" (
...
-- CreateTable
CREATE TABLE "order_order_files" (
    "order_id" INTEGER NOT NULL,
...
-- CreateTable
CREATE TABLE "product_budget_ranges" (
...
-- CreateTable
CREATE TABLE "project_status_status" (
    "project_id" INTEGER NOT NULL,
...
-- CreateIndex
CREATE INDEX "fk_challenges_projects1_idx" ON "challenges"("project_id");

-- CreateIndex
CREATE INDEX "fk_course_enrollment_users1_idx" ON "course_enrollments"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "unique_user_course_enrollment" ON "course_enrollments"("user_id", "course_id");

-- CreateIndex
CREATE UNIQUE INDEX "course_tags_course_id_tag_id_key" ON "course_tags"("course_id", "tag_id");

-- CreateIndex
CREATE UNIQUE INDEX "course_tools_course_id_tool_id_key" ON "course_tools"("course_id", "tool_id");
...
-- CreateIndex
CREATE INDEX "fk_invoices_orders1_idx" ON "invoices"("order_id");
...
-- CreateIndex
CREATE INDEX "fk_ordercoupons_coupon1_idx" ON "order_coupons"("coupon_id");

-- CreateIndex
CREATE INDEX "fk_orderorderfiles_orderfiles1_idx" ON "order_order_files"("order_file_id");

-- CreateIndex
CREATE INDEX "fk_projects_admins_idx" ON "orders"("user_id");

-- CreateIndex
CREATE INDEX "fk_projects_category1_idx" ON "orders"("category_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "category_name_unique" ON "product_categories"("category_name");

-- CreateIndex
CREATE INDEX "fk_ordercoupons_orders1_idx" ON "product_orders"("order_id");

-- CreateIndex
CREATE INDEX "fk_productorders_products1_idx" ON "product_orders"("product_id");

-- CreateIndex
CREATE UNIQUE INDEX "name_unique" ON "products"("name");

-- CreateIndex
CREATE INDEX "fk_products_category1_idx" ON "products"("category_id");

-- CreateIndex
CREATE INDEX "fk_projectowner_projects1_idx" ON "project_owner"("projectid");

-- CreateIndex
CREATE INDEX "fk_project_status_status_project_status1_idx" ON "project_status_status"("project_status_id");

-- CreateIndex
CREATE INDEX "fk_project_tools_tools1_idx" ON "project_tools"("tool_id");

-- CreateIndex
CREATE INDEX "fk_projecttools_projects1_idx" ON "project_tools"("project_id");

-- CreateIndex
CREATE UNIQUE INDEX "role_name_unique" ON "roles"("role_name");

-- CreateIndex
CREATE INDEX "fk_challenges_copy1_challenges1_idx" ON "solutions"("challenge_id");

-- CreateIndex
CREATE INDEX "fk_todos_projects1_idx" ON "todos"("project_id");

-- CreateIndex
CREATE UNIQUE INDEX "unique_user_role" ON "user_roles"("role_id", "user_id");
